...
namespace attendance_management_app.Services
{
    public class TurnDataStore
    {
        ...
        private TurnDataStore()
        {
            ...
            {
                new Turn{ TurnId = 1,Name = "Part Time Morning", StartTime = "08" , EndTime = "12", WorkingDays = new List<string> {"1", "2", "3", "4", "5" } },
                new Turn{ TurnId = 2,Name = "Part Time Afternoon", StartTime = "13" , EndTime = "17", WorkingDays = new List<string> {"1", "2", "3", "4", "5" } },
                new Turn {TurnId = 3,Name = "Full Time", StartTime = "08" , EndTime = "17", WorkingDays = new List<string> {"1", "2", "3", "4", "5" } }
            };
        }
